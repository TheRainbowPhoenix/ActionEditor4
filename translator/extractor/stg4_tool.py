...
class Stage(ActedBinaryFile):
    ...
    def _read_command(self) -> Command:
        ...
        reader_map = {
            ...
            15: self._read_summon_details, # ItemSummon
    ...
    def _write_command(self, cmd: Command):
        ...
        command_details_map = {
            ...
            14: SummonDetails, 15: SummonDetails, 16: FlowOperationDetails,
    ...
    def _read_summon_details(self) -> SummonDetails:
        ...
        d.bytes128_143 = self.read_bytes(16)
        # These fields are only for Block and Character summon, but reading them for Item summon is harmless
        # as the file structure is the same (just unused).
        ...
        if stage.parse():
            ...
            try:
                with open(out_file, 'w', encoding='utf-8') as f:
                    json.dump(stage.data, f, cls=DataclassJSONEncoder, indent=2)
