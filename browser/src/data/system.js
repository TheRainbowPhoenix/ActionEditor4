...
function writeStringArray(writer, values) {
    if (!Array.isArray(values)) {
        return;
    }
    for (const value of values) {
        writeStdString(writer, value);
    }
}

export function parseSystem(source) {
    const reader = ensureReader(source);
    const magic = reader.readUint32();
    const data = {
        unk0: reader.readUint32(),
        up_process_on_stage_clear: reader.readUint32(),
        score_per_1up: reader.readUint32(),
        space_pause: reader.readUint32(),
        hide_obj_pause: reader.readUint32(),
        show_symbol_image: reader.readUint32(),
        font_index: reader.readUint32(),
        decoration: reader.readUint32(),
        monospace: reader.readUint32(),
        min_damage_reduct_base: reader.readUint32(),
        min_damage_reduct_percent: reader.readUint32(),
        min_shock_reduct_base: reader.readUint32(),
        min_shock_reduct_percent: reader.readUint32(),
        enable_test_play_everywhere: reader.readUint32(),
        character_draw: reader.readUint32(),
        allow_replay_save: reader.readUint32(),
        alow_manual_replay_save: reader.readUint32(),
        replay_file_format: reader.readUint32(),
        use_explorer_file_dialog_for_file_select: reader.readUint32(),
        show_image_on_title_screen: reader.readUint32(),
        auto_save_default: reader.readUint32(),
        show_description: reader.readUint32(),
        share_lives_across_story: reader.readUint32(),
        return_worldmap_on_death: reader.readUint32(),
        show_lives_on_worldmap: reader.readUint32(),
        multistage_autosave_after_each_stage: reader.readUint32(),
        challenge_mode_world: reader.readUint32(),
        all_worlds_selectable_on_start: reader.readUint32(),
        show_highscore: reader.readUint32(),
        show_totalscore: reader.readUint32(),
        always_reset_commonvar_on_worldmap: reader.readUint32(),
        retry_pause_menu_option_in_cleared_worlds: reader.readUint32(),
        challenge_show_highscore: reader.readUint32(),
        challenge_show_totalscore: reader.readUint32(),
        challenge_death_reset_commonvar: reader.readUint32(),
        challenge_retry_pause_menu_option_in_cleared_worlds: reader.readUint32(),
        freemode_death_reset_commonvar: reader.readUint32(),
        testplay_death_reset_commonvar: reader.readUint32(),
        bitmap_color_mode: reader.readUint32(),
        transparent_color_r: reader.readUint8(),
        transparent_color_g: reader.readUint8(),
        transparent_color_b: reader.readUint8(),
        compat_v2_12: reader.readUint32(),
        compat_v2_60: reader.readUint32(),
        play_death_for_stauts_and_code_exec: reader.readUint32(),
        play_invincibility_effect: reader.readUint32(),
        invincibility_effect_speed: reader.readUint32(),
        enable_color_invincible_anim: reader.readUint32(),
        return_to_map_pause_menu_option: reader.readUint32(),
        compat_v5_23: reader.readUint32(),
        compat_v5_54: reader.readUint32(),
        compat_v6_16: reader.readUint32(),
        compat_v6_68: reader.readUint32(),
        compat_v6_76: reader.readUint32(),
        compat_v6_94: reader.readUint32(),
        unk_compat_alwayson: reader.readUint32(),
        compat_v6_96: reader.readUint32(),
        compat_v7_20: reader.readUint32(),
        compat_v7_22: reader.readUint32(),
        compat_v7_32: reader.readUint32(),
        compat_v7_34: reader.readUint32(),
        compat_v7_47: reader.readUint32(),
        compat_v7_51: reader.readUint32(),
        compat_v7_59: reader.readUint32(),
        compat_v7_47_nofx: reader.readUint32(),
        compat_v7_47_linfx: reader.readUint32(),
        compat_v7_72: reader.readUint32(),
        compat_v7_80: reader.readUint32(),
        compat_v7_81: reader.readUint32(),
        compat_v7_82: reader.readUint32(),
        compat_v7_92: reader.readUint32(),
        compat_v8_04: reader.readUint32(),
        compat_v8_07: reader.readUint32(),
        compat_v8_16: reader.readUint32(),
        compat_v8_17: reader.readUint32(),
        compat_v8_18: reader.readUint32(),
        compat_v8_21: reader.readUint32(),
        compat_v8_25: reader.readUint32(),
        compat_v8_29: reader.readUint32(),
        compat_v8_32: reader.readUint32(),
        compat_v8_36: reader.readUint32(),
        compat_v8_37: reader.readUint32(),
        compat_v8_40: reader.readUint32(),
        compat_v8_44_higherjump: reader.readUint32(),
        compat_v8_44_delayedjump: reader.readUint32(),
        compat_v8_44_lowerjump: reader.readUint32(),
        compat_v8_44_detach_riders: reader.readUint32(),
        compat_v8_60: reader.readUint32(),
        compat_v8_73: reader.readUint32(),
        compat_v8_90_wrap: reader.readUint32(),
        compat_v8_90_statuscode: reader.readUint32(),
        compat_v8_90_walkerY: reader.readUint32(),
        compat_v8_96: reader.readUint32(),
        compat_v9_03: reader.readUint32(),
        compat_v9_11: reader.readUint32(),
        compat_v9_12: reader.readUint32(),
        compat_v9_80: reader.readUint32(),
        compat_v9_85: reader.readUint32(),
        direct3_color_depth: reader.readUint32(),
        directdraw_color_depth: reader.readUint32(),
        go_title_after_stage_clear: reader.readUint32(),
        strings_count: reader.readUint32(),
        game_title: readStdString(reader),
        description: readStdString(reader)
    };

    const targetsCount = reader.readUint32();
    data.targets = {
        count: targetsCount,
        ...parseTargetFlags(reader, TARGET_KEYS)
    };

    const targetsResetedCount = reader.readUint32();
    data.targets_reseted = {
        count: targetsResetedCount,
        ...parseTargetFlags(reader, TARGET_RESET_KEYS)
    };

    const statusWindowCount = reader.readUint32();
    data.status_window_count = statusWindowCount;
    data.status_windows = loadElements(statusWindowCount, () => parseStatusWindow(reader));
...
function resolveNumeric(source, key, fallback = 0) {
...
export function serializeSystem(system) {
    ...
    if (typeof magic !== 'number') {
        throw new TypeError('System payload is missing a numeric magic field.');
    }
